...
class CompanyGetProvider implements ItemDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    {
        $this->authorizationAssertHelper->assertUserIsCompanyManagerOrAdmin($id);
    ...
    {
        return Company::class === $resourceClass && str_ends_with($operationName, ConstHelper::AS_MANAGER);
    }
}
