...
class EndUserGetProvider implements ItemDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    {
        return EndUser::class === $resourceClass && str_ends_with($operationName, ConstHelper::AS_MANAGER);
    }
}
